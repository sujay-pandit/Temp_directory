...
//
// On Fri Apr 15 12:47:02 EDT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkriscv(resetpc,
  ...
  reg [4 : 0] rd__h11663;
  wire [63 : 0] _theResult___snd_snd_snd__h11862, fl_pc__h11130;
  ...
  wire [4 : 0] _theResult___fst__h11762;
  wire NOT_IF_pipe4_first__85_BITS_136_TO_135_42_EQ_2_ETC___d257,
       lv_count_dtlb_misses__h2941,
       lv_count_itlb_misses__h2940;
  ...
  // submodule pipe1
  FIFO2 #(.width(32'd119), .guarded(1'd1)) pipe1(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(pipe1_D_IN),
						 .ENQ(pipe1_ENQ),
						 .DEQ(pipe1_DEQ),
  ...
  assign MUX_stage3_fwd_from_pipe4_first_1__VAL_1 =
	     { NOT_IF_pipe4_first__85_BITS_136_TO_135_42_EQ_2_ETC___d257,
		 ...
		 { _theResult___fst__h11762,
		   _theResult___snd_snd_snd__h11862,
  ...
  assign NOT_IF_pipe4_first__85_BITS_136_TO_135_42_EQ_2_ETC___d257 =
	     (rd__h11663 != 5'd0 ||
	      ((pipe4_D_OUT[136:135] == 2'd2) ?
		 pipe4_D_OUT[1] :
		 pipe4_D_OUT[136:135] != 2'd1)) &&
	     pipe4_D_OUT[0] == rg_wEpoch ;
  assign _theResult___fst__h11762 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[5:1] : 5'd0 ;
  assign _theResult___snd_snd_snd__h11862 =
	     (pipe4_D_OUT[136:135] == 2'd1) ? pipe4_D_OUT[69:6] : 64'd0 ;
  assign fl_pc__h11130 =
	     stage5_flush_fst ?
	       stage5_flush_snd_fst :
	       stage3_flush_from_exe_snd ;
  assign lv_count_dtlb_misses__h2941 =
	     EN_ma_dtlb_counters && ma_dtlb_counters_i ;
  assign lv_count_itlb_misses__h2940 =
  ...
  begin
    case (pipe4_D_OUT[136:135])
      2'd1: rd__h11663 = pipe4_D_OUT[5:1];
      2'd2: rd__h11663 = pipe4_D_OUT[11:7];
      default: rd__h11663 = 5'd0;
    endcase
  end
