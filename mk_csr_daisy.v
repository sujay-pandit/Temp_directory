...
//
// On Fri Apr 15 12:46:52 EDT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mk_csr_daisy(CLK,
  ...
  wire [15 : 0] x__h2417;
  wire [11 : 0] x__h2377;
  wire mk_grp1_mv_core_resp__6_BIT_64_7_OR_mk_grp2_mv_ETC___d65,
       mk_grp1_mv_mideleg__4_SRL_mav_upd_on_trap_c_BI_ETC___d97,
       y__h2414;
  ...
  assign mv_resp_to_core =
	     { mk_grp1_mv_core_resp__6_BIT_64_7_OR_mk_grp2_mv_ETC___d65,
	       anydata__h937 } ;
  ...
  assign rg_prv_EN = EN_mav_upd_on_trap || EN_mav_upd_on_ret ;
  ...
  assign mk_grp1_mav_upd_on_trap_prv = MUX_rg_prv_write_1__VAL_1 ;
  ...
  // remaining internal signals
  assign anydata__h937 = x__h2163 | mk_grp7_mv_core_resp[63:0] ;
  assign mk_grp1_mv_core_resp__6_BIT_64_7_OR_mk_grp2_mv_ETC___d65 =
  ...
  assign mk_grp1_mv_mideleg__4_SRL_mav_upd_on_trap_c_BI_ETC___d97 =
	     (x__h2377[0] & mav_upd_on_trap_c[5] || x__h2417[0] & y__h2414) &&
	     rg_prv <= 2'd1 ;
  assign x__h2163 = x__h2165 | mk_grp6_mv_core_resp[63:0] ;
  assign x__h2165 = x__h2167 | mk_grp5_mv_core_resp[63:0] ;
  assign x__h2167 = x__h2169 | mk_grp4_mv_core_resp[63:0] ;
  assign x__h2169 = x__h2171 | mk_grp3_mv_core_resp[63:0] ;
  assign x__h2171 = mk_grp1_mv_core_resp[63:0] | mk_grp2_mv_core_resp[63:0] ;
  assign x__h2377 = mk_grp1_mv_mideleg >> mav_upd_on_trap_c[4:0] ;
  assign x__h2417 = mk_grp1_mv_medeleg >> mav_upd_on_trap_c[4:0] ;
  assign y__h2414 = ~mav_upd_on_trap_c[5] ;
