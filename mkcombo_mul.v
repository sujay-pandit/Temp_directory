...
//
// On Fri Apr 15 12:46:02 EDT 2022
//
//
// Ports:
// Name                         I/O  size props
...
module mkcombo_mul(CLK,
  ...
  wire sign1__h1012, sign2__h1013;
  ...
  // value method mv_output
  assign mv_output = { x_wget__h657, rg_valid_0, 5'd0 } ;
  ...
  // register rg_op1_0
  assign rg_op1_0_D_IN = { sign1__h1012 & ma_inputs_in1[63], ma_inputs_in1 } ;
  assign rg_op1_0_EN = EN_ma_inputs ;

  // register rg_op2_0
  assign rg_op2_0_D_IN = { sign2__h1013 & ma_inputs_in2[63], ma_inputs_in2 } ;
  ...
  assign default_out__h885 =
	     { {32{IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1[31]}},
	       IF_rg_fn3_BITS_1_TO_0_EQ_0_THEN_signed_mul_oc__ETC__q1 } ;
  assign sign1__h1012 = ma_inputs_funct3[1] ^ ma_inputs_funct3[0] ;
  assign sign2__h1013 = ma_inputs_funct3[1:0] == 2'd1 ;
  assign x_wget__h657 =
	     rg_word ?
	       default_out__h885 :
